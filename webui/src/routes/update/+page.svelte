			...
			<CardContent class="py-5">
				<div class="mb-5 flex flex-wrap items-start gap-6">
					...
					<div>
						...
						<div class="font-mono text-sm font-semibold">{bcachefsInfo?.running_version ?? 'unknown'}{bcachefsInfo?.is_custom && bcachefsInfo?.pinned_rev ? ' @ ' + bcachefsInfo.pinned_rev : ''}</div>
